  ...
  const projects = [
    {
      ...
      year: "2024",
      role: "Team Lead",
      technologies: ["React.js", "Node.js", "Express.js", "MySQL", "Sequelize ORM"],
      description: "Web-based system for hostel management at the University of Jaffna. Part of MYUoJ",
    ...
    <section id="projects" className="section-container">
      ...
      <div className="space-y-12">
        {projects.map((project, index) => (
          <div key={index} className="card flex flex-col md:flex-row overflow-hidden">
            ...
            <div className="md:w-2/3 p-6">
              ...
              {project.role && <p className="text-lg font-medium text-slate-600 mb-2">{project.role}</p>}
              <p className="text-slate-700 mb-2">{project.description}</p>
              <p className="text-slate-600 mb-2">Technologies: {project.technologies.join(", ")}</p>
              <a href={project.link} target="_blank" rel="noopener noreferrer" className="btn inline-flex items-center">
                View Project
